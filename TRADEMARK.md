...
- Say your project is "built on Neva", "a fork of Neva", or "compatible with Neva".
- Keep the name in unmodified copies you pass to someone else.
- Use it in writing, talks, comparisons, and criticism, favourable or not.

## What needs written permission

- Naming your fork or product "Neva", or a name close enough to be mistaken for it.
- Using it in a domain, app-store listing, company name, or logo.
- Anything that would leave a reasonable person thinking your version is this one.
